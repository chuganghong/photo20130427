...
<META content="{dede:field.seokeywords /}" name=keywords>
<META content="{dede:field.seodiscription /}" name=description>
...
{dede:list row='24' pagesize='24'}
<li class="pic" style="height:200px"><a href="[field:arcurl/]" title="[field:title/]" target="_blank"><img src="[field:litpic/]"><span>[field:title/]</span></a></li>{/dede:list}
</div>
<div class="pagelist">
{dede:pagelist/}
</div>
