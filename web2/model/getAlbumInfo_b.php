...
function getAlbumInfos($db)
{
	...
	//获取图集到首页的小图的图集
	$sql2 = "SELECT album.id,album.albumName,album.thumbUrl,album.topicId FROM album,recommend WHERE album.topicId=1 AND album.id=recommend.albumId AND recommend.kind=3 LIMIT 8";
